...
try {
	Invoke-WebRequest -UseBasicParsing -Uri $url -ErrorAction Stop | Select-Object -ExpandProperty Content | Select-String -AllMatches 'href=["'']([^"'']+x86_64\.dll)["'']' | ForEach-Object {
